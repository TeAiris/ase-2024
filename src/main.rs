...
fn main() {
    ...
    // First argument is input .wav file, second argument is output .wav file,
    // third argument is filter type, fourth argument is gain, fifth argument is delay.
    ...
    // Open the input wave file and determine number of channels and sample rate
    ...
    for sample in reader.samples::<i16>() {
        ...
        let output_sample = (output_sample[0] * (1<<15) as f32) as i16;
